			...
			<div class="col-md-12">
					<div class="box box-primary">
						<div class="box-header with-border">
							<h3 class="box-title">ANALISIS RASIO</h3>
							</div>
...
echo '<div class="col-md-12">
	...
	<li><span class="fa fa-" aria-hidden="true"></span><b>Rasio lancar memiliki standar industri sebesar 2 kali jika hasil menunjukkan angka diatas 2 berarti perusahaan mampu membayar hutang jangka pendeknya atau disebut likuid</b></li>
	<li><span class="fa fa-" aria-hidden="true"></span><b>Rasio lancar memiliki standar industri sebesar 2 kali jika hasil menunjukkan angka dibawah 2 kali berarti perusahaan belum mampu membayar hutang jangka pendeknya atau disebut illikuid</b></li>
	</div>
	</div>
	</div>
	</div>
...
<?php
	$querytabel=$koneksi->query("select * from lancar");
?>
  <div class="col-md-6">
...
<?php
$JPFA2014 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiolancar where kode='JPFA' and tahun='2014' ")or die(mysqli_error());
$JPFA2015 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiolancar where kode='JPFA' and tahun='2015' ")or die(mysqli_error());
$JPFA2016 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiolancar where kode='JPFA' and tahun='2016' ")or die(mysqli_error());
//SIPD
$SIPD2014 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiolancar where kode='SIPD' and tahun='2014' ")or die(mysqli_error());
$SIPD2015 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiolancar where kode='SIPD' and tahun='2015' ")or die(mysqli_error());
$SIPD2016 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiolancar where kode='SIPD' and tahun='2016' ")or die(mysqli_error());
//MAIN
$MAIN2014 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiolancar where kode='MAIN' and tahun='2014' ")or die(mysqli_error());
$MAIN2015 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiolancar where kode='MAIN' and tahun='2015' ")or die(mysqli_error());
$MAIN2016 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiolancar where kode='MAIN' and tahun='2016' ")or die(mysqli_error());
//CPIN
$CPIN2014 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiolancar where kode='CPIN' and tahun='2014' ")or die(mysqli_error());
$CPIN2015 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiolancar where kode='CPIN' and tahun='2015' ")or die(mysqli_error());
$CPIN2016 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiolancar where kode='CPIN' and tahun='2016' ")or die(mysqli_error());
