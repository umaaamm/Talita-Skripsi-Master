...
<body>
	...
	<div class="inner_page_agile">
		<h3>Laporan Debt To Equity Ratio</h3>
			...
			<div class="col-md-12">
					<div class="box box-primary">
						<div class="box-header with-border">
							<h3 class="box-title">Debt to Equity Ratio</h3>
							</div>
							<div class="box-body">
...
echo '<div class="col-md-12">
	...
	<li><span class="fa fa-" aria-hidden="true"></span><b>Debt To Equity Ratio memiliki standar industri sebesar 90% jika hasil menunjukkna angka diatas 80% maka semakin tidak menguntungkan untuk kreditur karena akan semakin besar resiko kegagalan yang mungkin terjadi di perusahaan</b></li>
	<li><span class="fa fa-" aria-hidden="true"></span><b>Debt To Equity Ratio memiliki standar industri sebesar 90%  jika hasil menunjukkan angka dibawah 80% maka semakin tinggi tingkat pendanaan yang disediakan oleh perusahaan.</b></li>
	</div>
	</div>
	</div>
	</div>
...
?>
<?php
	$querytabel=$koneksi->query("select * from debt_equity");
?>
  <div class="col-md-6">
...
<?php
$JPFA2014 = mysqli_query( $koneksi,"SELECT kode,hasil from debtequity where kode='JPFA' and tahun='2014' ")or die(mysqli_error());
$JPFA2015 = mysqli_query( $koneksi,"SELECT kode,hasil from debtequity where kode='JPFA' and tahun='2015' ")or die(mysqli_error());
$JPFA2016 = mysqli_query( $koneksi,"SELECT kode,hasil from debtequity where kode='JPFA' and tahun='2016' ")or die(mysqli_error());
//SIPD
$SIPD2014 = mysqli_query( $koneksi,"SELECT kode,hasil from debtequity where kode='SIPD' and tahun='2014' ")or die(mysqli_error());
$SIPD2015 = mysqli_query( $koneksi,"SELECT kode,hasil from debtequity where kode='SIPD' and tahun='2015' ")or die(mysqli_error());
$SIPD2016 = mysqli_query( $koneksi,"SELECT kode,hasil from debtequity where kode='SIPD' and tahun='2016' ")or die(mysqli_error());
//MAIN
$MAIN2014 = mysqli_query( $koneksi,"SELECT kode,hasil from debtequity where kode='MAIN' and tahun='2014' ")or die(mysqli_error());
$MAIN2015 = mysqli_query( $koneksi,"SELECT kode,hasil from debtequity where kode='MAIN' and tahun='2015' ")or die(mysqli_error());
$MAIN2016 = mysqli_query( $koneksi,"SELECT kode,hasil from debtequity where kode='MAIN' and tahun='2016' ")or die(mysqli_error());
//CPIN
$CPIN2014 = mysqli_query( $koneksi,"SELECT kode,hasil from debtequity where kode='CPIN' and tahun='2014' ")or die(mysqli_error());
$CPIN2015 = mysqli_query( $koneksi,"SELECT kode,hasil from debtequity where kode='CPIN' and tahun='2015' ")or die(mysqli_error());
$CPIN2016 = mysqli_query( $koneksi,"SELECT kode,hasil from debtequity where kode='CPIN' and tahun='2016' ")or die(mysqli_error());
