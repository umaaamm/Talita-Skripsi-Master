...
<body>
	...
	<div class="inner_page_agile">
		<h3>Laporan Debt To Asset Ratio</h3>
...
echo '<div class="col-md-12">
	...
	<li><span class="fa fa-" aria-hidden="true"></span><b>Debt To Asset Ratio memiliki standar industri sebesar 35% jika hasil menunjukkan angka dibawah 35% maka semakin kecil perusahaan dibiayai dengan 
	utang dan perusahaan mampu membayar hutang jangka panjangnya atau disebut dengan solvable</b></li>
	<li><span class="fa fa-" aria-hidden="true"></span><b>Debt To Asset Ratio memiliki standar industri sebesar 35% jika hasil menunjukkan angka diatas 35% akan sulit bagi
	perusahaan untuk memperoleh pinjaman.</b></li>
	</div>
	</div>
	</div>
	</div>
...
?>		
<?php
	$querytabel=$koneksi->query("select * from debt_ratio");
?>
  <div class="col-md-6">
...
<?php
$JPFA2014 = mysqli_query( $koneksi,"SELECT kode,hasil from debtratio where kode='JPFA' and tahun='2014' ")or die(mysqli_error());
$JPFA2015 = mysqli_query( $koneksi,"SELECT kode,hasil from debtratio where kode='JPFA' and tahun='2015' ")or die(mysqli_error());
$JPFA2016 = mysqli_query( $koneksi,"SELECT kode,hasil from debtratio where kode='JPFA' and tahun='2016' ")or die(mysqli_error());
//SIPD
$SIPD2014 = mysqli_query( $koneksi,"SELECT kode,hasil from debtratio where kode='SIPD' and tahun='2014' ")or die(mysqli_error());
$SIPD2015 = mysqli_query( $koneksi,"SELECT kode,hasil from debtratio where kode='SIPD' and tahun='2015' ")or die(mysqli_error());
$SIPD2016 = mysqli_query( $koneksi,"SELECT kode,hasil from debtratio where kode='SIPD' and tahun='2016' ")or die(mysqli_error());
//MAIN
$MAIN2014 = mysqli_query( $koneksi,"SELECT kode,hasil from debtratio where kode='MAIN' and tahun='2014' ")or die(mysqli_error());
$MAIN2015 = mysqli_query( $koneksi,"SELECT kode,hasil from debtratio where kode='MAIN' and tahun='2015' ")or die(mysqli_error());
$MAIN2016 = mysqli_query( $koneksi,"SELECT kode,hasil from debtratio where kode='MAIN' and tahun='2016' ")or die(mysqli_error());
//CPIN
$CPIN2014 = mysqli_query( $koneksi,"SELECT kode,hasil from debtratio where kode='CPIN' and tahun='2014' ")or die(mysqli_error());
$CPIN2015 = mysqli_query( $koneksi,"SELECT kode,hasil from debtratio where kode='CPIN' and tahun='2015' ")or die(mysqli_error());
$CPIN2016 = mysqli_query( $koneksi,"SELECT kode,hasil from debtratio where kode='CPIN' and tahun='2016' ")or die(mysqli_error());
