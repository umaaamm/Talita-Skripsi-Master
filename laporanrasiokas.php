...
echo '<div class="col-md-12">
	...
	<li><span class="fa fa-" aria-hidden="true"></span><b>Rasio kas memiliki standar industri sebesar 50% jika hasil menunjukkan angka diatas 50% maka keadaan perusahaan lebih baik atau disebut likuid</b></li>
	<li><span class="fa fa-" aria-hidden="true"></span><b>Rasio kas memiliki standar industri sebesar 50% jika hasil menunjukkan angka dibawah 50% maka perusahaan dalam keadaan kurang baik karena perusahaan harus menjual atau 
	menagih hutang lainnya untuk membayar hutang jangka pendeknya atau disebut illikuid.</b></li>
	</div>
	</div>
	</div>
	</div>
...
?>
<?php
	$querytabel=$koneksi->query("select * from kas");
?>
  <div class="col-md-6">
			...
			<div class="footer_bottom">
				<div class="col-md-9 footer_bottom_grid">
					<div class="footer_bottom1">
						...
						<p>© 2018 Talita Dwi Aditya. All rights reserved</a></p>
					</div>
				</div>
...
<?php
$JPFA2014 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiokas where kode='JPFA' and tahun='2014' ")or die(mysqli_error());
$JPFA2015 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiokas where kode='JPFA' and tahun='2015' ")or die(mysqli_error());
$JPFA2016 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiokas where kode='JPFA' and tahun='2016' ")or die(mysqli_error());
//SIPD
$SIPD2014 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiokas where kode='SIPD' and tahun='2014' ")or die(mysqli_error());
$SIPD2015 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiokas where kode='SIPD' and tahun='2015' ")or die(mysqli_error());
$SIPD2016 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiokas where kode='SIPD' and tahun='2016' ")or die(mysqli_error());
//MAIN
$MAIN2014 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiokas where kode='MAIN' and tahun='2014' ")or die(mysqli_error());
$MAIN2015 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiokas where kode='MAIN' and tahun='2015' ")or die(mysqli_error());
$MAIN2016 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiokas where kode='MAIN' and tahun='2016' ")or die(mysqli_error());
//CPIN
$CPIN2014 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiokas where kode='CPIN' and tahun='2014' ")or die(mysqli_error());
$CPIN2015 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiokas where kode='CPIN' and tahun='2015' ")or die(mysqli_error());
$CPIN2016 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiokas where kode='CPIN' and tahun='2016' ")or die(mysqli_error());
