...
echo '<div class="col-md-12">
	...
	<li><span class="fa fa-" aria-hidden="true"></span><b>Rasio cepat memiliki standar industri sebesar 1,5 kali jika hasil menunjukkan angka diatas 1,5 kali maka keadaan perusahaan lebih baik karena peusahaan tidak harus menjual persediaan nya untuk membayar hutang jangka pendeknya atau disebut likuid</b></li>
	<li><span class="fa fa-" aria-hidden="true"></span><b>Rasio cepat memiliki standar industri sebesar 1,5 kali jika hasil menunjukkan angka dibawah 1,5 kali maka perusahaan dalam keadaan kurang baik karena harus menjual persediaannya untuk membayar hutang jangka pendek atau disebut illikuid.</b></li>
	</div>
	</div>
	</div>
	</div>
...
<?php
	$querytabel=$koneksi->query("select * from cepat");
?>
  <div class="col-md-6">
			...
			<div class="footer_bottom">
				<div class="col-md-9 footer_bottom_grid">
					<div class="footer_bottom1">
						<a href="index.html">
							<h2><span class="fa fa-signal" aria-hidden="true"></span> Analisis dan Perancangan <label>Sistem Perhitungan Rasio Keuangan Berbasis Web</label></h2>
						</a>
						<p>© 2018  Talitha Dwi Aditya | Design by <a href="http://w3layouts.com">W3layouts</a></p>
					</div>
				</div>
				</div>
...
<?php
$JPFA2014 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiocepat where kode='JPFA' and tahun='2014' ")or die(mysqli_error());
$JPFA2015 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiocepat where kode='JPFA' and tahun='2015' ")or die(mysqli_error());
$JPFA2016 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiocepat where kode='JPFA' and tahun='2016' ")or die(mysqli_error());
//SIPD
$SIPD2014 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiocepat where kode='SIPD' and tahun='2014' ")or die(mysqli_error());
$SIPD2015 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiocepat where kode='SIPD' and tahun='2015' ")or die(mysqli_error());
$SIPD2016 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiocepat where kode='SIPD' and tahun='2016' ")or die(mysqli_error());
//MAIN
$MAIN2014 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiocepat where kode='MAIN' and tahun='2014' ")or die(mysqli_error());
$MAIN2015 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiocepat where kode='MAIN' and tahun='2015' ")or die(mysqli_error());
$MAIN2016 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiocepat where kode='MAIN' and tahun='2016' ")or die(mysqli_error());
//CPIN
$CPIN2014 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiocepat where kode='CPIN' and tahun='2014' ")or die(mysqli_error());
$CPIN2015 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiocepat where kode='CPIN' and tahun='2015' ")or die(mysqli_error());
$CPIN2016 = mysqli_query( $koneksi,"SELECT kode,hasil from rasiocepat where kode='CPIN' and tahun='2016' ")or die(mysqli_error());
