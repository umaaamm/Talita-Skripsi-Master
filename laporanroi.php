...
<body>
	...
	<div class="inner_page_agile">
		<h3>Laporan Return On Investment</h3>
...
echo '<div class="col-md-12">
	...
	<li><span class="fa fa-" aria-hidden="true"></span><b>Return On Investment memiliki standar industri sebesar 30% jika hasil mununjukkan angka diatas 30$ maka efektivitas dari keseluruhan operasi perusahaan dalam keadaan baik</b></li>
	<li><span class="fa fa-" aria-hidden="true"></span><b>Return On Investment memiliki standar industri sebesar 30% jika hasil menunjukkan angka dibawah 30% maka perusahaan kurang baik bisa disebabkan oleh rendahnya perputaran aktiva.</b></li>
	</div>
	</div>
	</div>
	</div>
...
?>		
<?php
	$querytabel=$koneksi->query("select * from return_investment");
?>
  <div class="col-md-6">
  <div class="box box-success">
            ...
            <div class="box-body">
							<table id="example1" class="table table-bordered table-striped" style="border-color:#000000;">
							<thead>
								<tr>
...
<?php
$JPFA2014 = mysqli_query( $koneksi,"SELECT kode,hasil from roi where kode='JPFA' and tahun='2014' ")or die(mysqli_error());
$JPFA2015 = mysqli_query( $koneksi,"SELECT kode,hasil from roi where kode='JPFA' and tahun='2015' ")or die(mysqli_error());
$JPFA2016 = mysqli_query( $koneksi,"SELECT kode,hasil from roi where kode='JPFA' and tahun='2016' ")or die(mysqli_error());
//SIPD
$SIPD2014 = mysqli_query( $koneksi,"SELECT kode,hasil from roi where kode='SIPD' and tahun='2014' ")or die(mysqli_error());
$SIPD2015 = mysqli_query( $koneksi,"SELECT kode,hasil from roi where kode='SIPD' and tahun='2015' ")or die(mysqli_error());
$SIPD2016 = mysqli_query( $koneksi,"SELECT kode,hasil from roi where kode='SIPD' and tahun='2016' ")or die(mysqli_error());
//MAIN
$MAIN2014 = mysqli_query( $koneksi,"SELECT kode,hasil from roi where kode='MAIN' and tahun='2014' ")or die(mysqli_error());
$MAIN2015 = mysqli_query( $koneksi,"SELECT kode,hasil from roi where kode='MAIN' and tahun='2015' ")or die(mysqli_error());
$MAIN2016 = mysqli_query( $koneksi,"SELECT kode,hasil from roi where kode='MAIN' and tahun='2016' ")or die(mysqli_error());
//CPIN
$CPIN2014 = mysqli_query( $koneksi,"SELECT kode,hasil from roi where kode='CPIN' and tahun='2014' ")or die(mysqli_error());
$CPIN2015 = mysqli_query( $koneksi,"SELECT kode,hasil from roi where kode='CPIN' and tahun='2015' ")or die(mysqli_error());
$CPIN2016 = mysqli_query( $koneksi,"SELECT kode,hasil from roi where kode='CPIN' and tahun='2016' ")or die(mysqli_error());
