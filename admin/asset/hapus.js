...
modal.find('#hapus-true-data8').attr("href","?f1=admin&f2=admin&id_delete="+id);
modal.find('#hapus-true-data9').attr("href","?f1=perusahaan&f2=perusahaan&id_delete="+id);
modal.find('#true-data-keluar').attr("href","logout.php");
})
