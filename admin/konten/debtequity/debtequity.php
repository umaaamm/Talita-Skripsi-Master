...
if(isset($_POST['submit'])){
  ...
  if($rumus<=$angka){
		...
		if (!empty($kode && $tahun && $total_utang && $total_ekuitas ) ) {
...
<div class="row">
        ...
        <div class="col-md-4">
          ...
          <!-- /.box -->
			...
			<div class="col-md-8">
				<?php
				$query=$koneksi->query("select * from debtequity");
				?>
					<div class="box box-primary">
						<div class="box-header with-border">
							...
							<?php
								...
								<td>
								<a href="javascript:;" data-id="<? echo $tampil['id_debtequity']?>" data-toggle="modal" data-target="#modal-konfirmasi" class="btn btn-success btn-danger fa fa-trash"></a>
								<a href="?f1=debtequity&f2=edit-debtequity&id_edit=<?=$tampil['id_debtequity']?>" class="btn btn-success btn-primary fa fa-edit"></a></td>
								</tr>
            ...
            <div class="modal-footer">
                <a href="javascript:;" class="btn btn-danger" id="hapus-true-data4">Hapus</a>
