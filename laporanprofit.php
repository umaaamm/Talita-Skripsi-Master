...
<body>
	...
	<div class="inner_page_agile">
		<h3>Laporan Profit Margin On Sales</h3>
...
echo '<div class="col-md-12">
	...
	<li><span class="fa fa-" aria-hidden="true"></span><b>Profit Margin On Sales memiliki standar industri sebesar 20% jika hasil menunjukkan angka diatas 20% maka perusahaan dikatakan dalam keadaan baik karena 
	menghasilkan margin laba yang tinggi atau disebut rendabel</b></li>
	<li><span class="fa fa-" aria-hidden="true"></span><b>Profit Margin On Sales memiliki standar industri sebesar 20% jika hasil menunjukkan angka dibawah 20% maka perusahaan kurang baik bisa disebabkan dari harga barang perusahan 
	relatif rendah atau biaya-biaya relatif tinggi atau disebut unrendabel.</b></li>
	</div>
	</div>
	</div>
	</div>
...
?>
<?php
	$querytabel=$koneksi->query("select * from profit_margin");
?>
  <div class="col-md-6">
...
<?php
$JPFA2014 = mysqli_query( $koneksi,"SELECT kode,hasil from profit where kode='JPFA' and tahun='2014' ")or die(mysqli_error());
$JPFA2015 = mysqli_query( $koneksi,"SELECT kode,hasil from profit where kode='JPFA' and tahun='2015' ")or die(mysqli_error());
$JPFA2016 = mysqli_query( $koneksi,"SELECT kode,hasil from profit where kode='JPFA' and tahun='2016' ")or die(mysqli_error());
//SIPD
$SIPD2014 = mysqli_query( $koneksi,"SELECT kode,hasil from profit where kode='SIPD' and tahun='2014' ")or die(mysqli_error());
$SIPD2015 = mysqli_query( $koneksi,"SELECT kode,hasil from profit where kode='SIPD' and tahun='2015' ")or die(mysqli_error());
$SIPD2016 = mysqli_query( $koneksi,"SELECT kode,hasil from profit where kode='SIPD' and tahun='2016' ")or die(mysqli_error());
//MAIN
$MAIN2014 = mysqli_query( $koneksi,"SELECT kode,hasil from profit where kode='MAIN' and tahun='2014' ")or die(mysqli_error());
$MAIN2015 = mysqli_query( $koneksi,"SELECT kode,hasil from profit where kode='MAIN' and tahun='2015' ")or die(mysqli_error());
$MAIN2016 = mysqli_query( $koneksi,"SELECT kode,hasil from profit where kode='MAIN' and tahun='2016' ")or die(mysqli_error());
//CPIN
$CPIN2014 = mysqli_query( $koneksi,"SELECT kode,hasil from profit where kode='CPIN' and tahun='2014' ")or die(mysqli_error());
$CPIN2015 = mysqli_query( $koneksi,"SELECT kode,hasil from profit where kode='CPIN' and tahun='2015' ")or die(mysqli_error());
$CPIN2016 = mysqli_query( $koneksi,"SELECT kode,hasil from profit where kode='CPIN' and tahun='2016' ")or die(mysqli_error());
